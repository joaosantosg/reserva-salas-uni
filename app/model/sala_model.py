from sqlalchemy import Column, String, Integer, Boolean, ForeignKey, UniqueConstraint, ARRAY, Text, DateTime
...
class Sala(BaseModel):
    ...
    curso_restrito = Column(String(100), nullable=True, comment="Curso restrito para uso da sala")
