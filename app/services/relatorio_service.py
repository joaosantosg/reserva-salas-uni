...
class RelatorioService:
    ...
    def gerar_relatorio_uso_salas(self, data_inicio: datetime, data_fim: datetime) -> dict:
        """
        ...
        return {
            ...
            "resumo": {
                "total_reservas": sum(s["total_reservas"] for s in stats_por_sala.values()),
                "media_ocupacao": sum(s["taxa_ocupacao"] for s in stats_por_sala.values()) / len(stats_por_sala) if stats_por_sala else 0
            }
        } 